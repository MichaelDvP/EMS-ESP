...
MAKE_PSTR(upTimeControltxt, "Operating time control")
MAKE_PSTR(upTimeCompHeatingtxt, "Operating time compressor heating")
MAKE_PSTR(upTimeCompCoolingtxt, "Operating time compressor cooling")
MAKE_PSTR(upTimeCompWwtxt, "Operating time compressor warm water")
MAKE_PSTR(upTimeControl, "Operating time control (min)")
MAKE_PSTR(upTimeCompHeating, "Operating time compressor heating (min)")
MAKE_PSTR(upTimeCompCooling, "Operating time compressor cooling (min)")
MAKE_PSTR(upTimeCompWw, "Operating time compressor warm water (min)")
...
MAKE_PSTR(reducemode, "Reducemode")
MAKE_PSTR(mode, "Mode")
