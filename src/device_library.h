...
{ 68, DeviceType::CONTROLLER, F("BC10/MC10"), DeviceFlags::EMS_DEVICE_FLAG_NONE}, // 0x09
...
{207, DeviceType::CONTROLLER, F("Sense II/CS200"), DeviceFlags::EMS_DEVICE_FLAG_NONE}, // 0x10 -> solar thermostat
